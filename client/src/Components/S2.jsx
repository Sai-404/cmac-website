    ...
    <section className="max-w-7xl mx-auto px-6 py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-sm p-6">
          <div className="aspect-[3/2] rounded-2xl bg-[#FDF6EC] mb-6">
            <img 
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm p-6 flex gap-6 items-center">
            <div className="w-32 h-32 flex-shrink-0 rounded-2xl bg-[#FFF4EC] overflow-hidden">
              <img 
          ...
          {/* Second Small Card */}
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm p-6 flex gap-6 items-center">
            <div className="w-32 h-32 flex-shrink-0 rounded-2xl bg-[#E8F7F3] overflow-hidden">
              <img 
                src="/api/placeholder/128/128"
                alt=""
                className="w-full h-full object-cover"
