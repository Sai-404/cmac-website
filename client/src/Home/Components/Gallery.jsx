...
const Gallery = () => {
  const images = [
    { src: galleryImage2, alt: 'Winners of the event celebrating their victory', caption: 'Winners' },
    { src: galleryImage3, alt: 'Teams discussing strategies during the event', caption: 'Runners' },
    { src: galleryImage5, alt: 'Runners celebrating their achievement', caption: 'Teams Discussing' },
    { src: galleryImage4, alt: 'Judges panel evaluating the participants', caption: 'Judges Panel' },
    { src: galleryImage1, alt: 'Organization team posing for a group photo', caption: 'Organization Team' },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#FFF7ED] overflow-hidden">
      <Header />
      <main className="flex-grow flex flex-col items-center justify-center py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <motion.div
