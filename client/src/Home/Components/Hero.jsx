        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            ...
            <button
              ...
              className={`w-full sm:w-auto px-8 py-3 bg-white text-gray-900 rounded-full font-medium hover:bg-gray-100 transition-colors text-sm sm:text-base ${
                isClicked ? 'border-none' : 'border border-gray-200'
              }`}
...
>>>>>>> f3337183aa1f61ac7d825e712da722d17b1639fb
  );
};
