...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF7ED]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-24 overflow-hidden">
        <div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div 
            className={`bg-white rounded-lg shadow-sm p-8 transform transition-all duration-700 ease-out delay-100 ${
              isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'
            }`}
          >
          ...
          <div 
            className={`bg-white rounded-lg shadow-sm p-8 flex flex-col items-center justify-center transform transition-all duration-700 ease-out delay-200 ${
              isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'
            }`}
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#AD0000] text-white px-8 py-4 rounded-lg hover:bg-[#8a0000] transition-colors duration-200"
            >
